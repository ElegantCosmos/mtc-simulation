...
MTCG4Trajectory::MTCG4Trajectory()
{
	...
	fCreatorProcessName = "";
	fCreatorProcessType = fNotDefined;
	fCreatorProcessSubType = 0;
	ParticleName = "";
	PDGCharge = 0;
	PDGEncoding = 0;
	fTrackID = 0;
...
MTCG4Trajectory::MTCG4Trajectory(const G4Track* aTrack)
{
	...
	if(aTrack->GetCreatorProcess()) {
		fCreatorProcessName = aTrack->GetCreatorProcess()->GetProcessName();
		fCreatorProcessType = aTrack->GetCreatorProcess()->GetProcessType();
		fCreatorProcessSubType = aTrack->GetCreatorProcess()->GetProcessSubType();
	}
	else {
		fCreatorProcessName = "";
		fCreatorProcessType = fNotDefined;
	...
	: G4Trajectory(right)
{
	...
	fCreatorProcessSubType = right.fCreatorProcessSubType;
...
{
	// "os" here is defaulted to G4cout in ShowTrajectory method of base class.
	os << G4endl << "TrackID =" << fTrackID 
		<< " : ParentID=" << fParentID << G4endl;
	os << "Creator process name : " << fCreatorProcessName << G4endl;
