...
void PESdsIO::Write(const G4Event* theEvent)
{
	...
	//				data.push_back(photon->GetTime()/ns);
	...
	//				//	std::endl;
	//				
	//				// Set hit pixel x, y, z position.
	//				data.push_back(photon->GetCount());
	//				double hitPixel_x;
	//				double hitPixel_y;
	//				double hitPixel_z;
	//				photon->GetPosition(hitPixel_x, hitPixel_y, hitPixel_z);
	//				data.push_back(hitPixel_x);
	//				data.push_back(hitPixel_y);
	//				data.push_back(hitPixel_z);
	//			}
